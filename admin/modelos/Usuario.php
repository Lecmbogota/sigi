...
public function insertar($nombre,$apellidos,$cedula,$login,$iddepartamento,$idtipousuario,$email,$clavehash,$usuariocreado,$codigo_persona){
...
public function editar($idusuario,$nombre,$apellidos,$cedula,$login,$iddepartamento,$idtipousuario,$email,$usuariocreado,$codigo_persona){
