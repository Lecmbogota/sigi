...
public function insertar($ee_id,$ee_encuestador,$ee_fecha,$ee_estudio,$ee_estatus){
...
public function editar($id_carga,$ee_id,$ee_encuestador,$ee_fecha,$ee_estudio,$ee_estatus){
