...
function mostrar(idusuario) {
  $.post('../ajax/usuario.php?op=mostrar', { idusuario: idusuario }, function (
    data,
    status,
  ) {
    ...
    $('#usr_rotator').val(data.usr_rotator)
    $('#pwd_rotator').val(data.pwd_rotator)
  })
...
function mostrar_clave(idusuario) {
  ...
  $.post(
    '../ajax/usuario.php?op=mostrar_clave',
    { idusuario: idusuario },
