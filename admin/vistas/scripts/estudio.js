...
function mostrar_clave(id_Estudio) {
  ...
  $.post(
    '../ajax/estudio.php?op=mostrar_clave',
    { id_Estudio: id_Estudio },
    function (data, status) {
      data = JSON.parse(data)
...
function eliminaregistro(id_Estudio) {
  bootbox.confirm('¿Esta seguro de Eliminar este Estudio?', function (result) {
    if (result) {
      $.post(
        '../ajax/estudio.php?op=eliminaregistro',
        { id_Estudio: id_Estudio },
        function (e) {
          bootbox.alert(e)
          tabla.ajax.reload()
...
function desactivar(id_Estudio) {
  bootbox.confirm('¿Esta seguro de Cerrar este Estudio?', function (result) {
    if (result) {
      $.post(
        '../ajax/estudio.php?op=desactivar',
        { id_Estudio: id_Estudio },
        function (e) {
          bootbox.alert(e)
          tabla.ajax.reload()
