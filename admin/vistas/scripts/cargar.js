...
function init(){
                    ...
                    success:function(respuesta){
                        ...
                        if( respuesta['totalProductos'] > 0 ){
                            ...
                            Swal.fire({
                                position:'center',
                                icon:'success',
                                title: 'Se registraron ' + respuesta['totalProductos'] +' '+ ' Encuestas correctamente!',
                                showConfirmButton: false,
                                timer: 2500
                            })
                            ...
                            Swal.fire({
                                position:'center',
                                icon:'error',
                                title: 'Se presento un error al momento de realizar la carga del archivo!',
                                showConfirmButton: false,
                                timer: 2500
                            })
    ...
    $('#myModal').on('shown.bs.modal', function () {
      ...
      $("#fileRequest").click(function() {
        ...
        window.location = 'admin/public/plantillas/ENCUESTAS_EFECTIVAS_PLANTILLA_SIGI.xlsx';
    });
}
