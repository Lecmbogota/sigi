...
function init() {
  ...
  $.post('../ajax/Capacitacion.php?op=selectEstudio', function (r) {
    $('#estudio').html(r)
    $('#estudio').selectpicker('refresh')
  })

  //cargamos los items al select Agente
  $.post('../ajax/Capacitacion.php?op=selectAgente', function (r) {
    $('#idcliente').html(r)
...
function mostrar(id_capacitacion) {
  $.post(
    '../ajax/capacitacion.php?op=mostrar',
  ...
  $.post(
    '../ajax/capacitacion.php?op=permisos&id=' + id_capacitacion,
    function (r) {
      $('#permisos').html(r)
    },
  )
